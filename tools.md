...
> 包含 Meme 随机图、Minecraft、Steam 及 AI 语音。
...
<li><code>[关键词]</code>：随机发送表情</li>
<li><code>[关键词] 查看</code>：生成预览图</li>
<li><code>[关键词] 上传 [图]</code>：投稿表情</li>
</ul>
</div>
<div style="flex: 1; min-width: 240px;">
<ul style="font-size: 13px; line-height: 1.8; color: #555; padding-left: 20px;">
<li><strong>引用回复：</strong> "溯源" (查作者), "删除" (管理), "同意/拒绝" (审核)</li>
</ul>
</div>
</div>
<!-- PJSK 表情入口 -->
<div style="margin-top: 15px; border-top: 1px dashed #d3adf7; padding-top: 10px;">
<span style="font-size: 13px; color: #eb2f96; font-weight: bold;">🎨 也要做 PJSK 表情？</span>
<span style="font-size: 13px; color: #666;">指令: <code>pjsk [角色] [文本]</code></span>
<a href="#/meme" style="margin-left: 10px; font-size: 12px; color: #722ed1; text-decoration: underline;">查看教程 -></a>
</div>
</div>
