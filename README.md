<div style="text-align: center; margin-top: 30px;">
  ...
  <!-- 头像：改回 120px，正常大小 -->
  <img src="Picture/avatar.jpg" width="120" height="120" style="border-radius: 50%; object-fit: cover; box-shadow: 0 4px 15px rgba(233, 126, 179, 0.4); border: 3px solid #E97EB3; margin-bottom: 20px;">
  ...
  <!-- 语录 -->
  <p id="mizuki-quote" style="color: #999; font-style: italic; margin-bottom: 20px; font-weight: bold; min-height: 45px; line-height: 1.6;">
    Loading...
  </p>
